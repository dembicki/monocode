...
export function ModelPicker({
  ...
  useEffect(() => {
    const inBlockingUi = (target: EventTarget | null) => {
      ...
      return Boolean(
        target.closest(
          "[data-file-picker], [data-session-switcher], [data-project-switcher], [data-branch-picker], [data-skill-picker], [data-mention-picker], [data-access-picker], [data-model-settings]",
        ),
      );
    };
